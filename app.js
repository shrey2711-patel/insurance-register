...
function sendAuthOTP(method) {
  ...
  if (twilioSid && twilioToken && twilioNumber) {
    try {
      ...
      body.append('Body', `Midas Money Care verification code: ${otp}`);
...
function useSandboxFirebase() {
  ...
  document.getElementById('settingsFirebaseAuthDomain').value = "midas-money-care-sandbox.firebaseapp.com";
  document.getElementById('settingsFirebaseProjectId').value = "midas-money-care-sandbox";
  document.getElementById('settingsFirebaseStorageBucket').value = "midas-money-care-sandbox.appspot.com";
